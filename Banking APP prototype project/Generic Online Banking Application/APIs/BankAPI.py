...
class API:
    ...
    def __post_init__(self):
        self._name = E.Bank('Demo Bank','2 Skywalket Avenue', 'Oacis', 'Marsian City', 'Mars','184 3DE').bankName
        self._headers = (getBankCustomers(),getBankAccountsIDs())
        self._body = getBankAccounts()
        self._endpoint = db.connect(host='localhost', user='root', passwd='root', port=3306, database='bankdb')
    @property
    def name(self):
        return self._name
    @property
