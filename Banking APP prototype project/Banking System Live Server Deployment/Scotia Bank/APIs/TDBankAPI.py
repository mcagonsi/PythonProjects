...
class API:
    ...
    def __post_init__(self):
        self._name = E.Bank('TD BANK','2 Skywalket Avenue', 'Oacis', 'Marsian City', 'Mars','184 3DE').bankName
        self._endpoint = db.connect(host='localhost', user='root', passwd='root', port=3306, database='tdbankdb')
...
def getBankAccountsIDs():
    CON = db.connect(host='localhost', user='root', passwd='root', port=3306, database='tdbankdb')
    C = CON.cursor()
