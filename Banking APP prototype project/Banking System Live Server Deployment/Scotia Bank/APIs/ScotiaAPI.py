...
class API:
    ...
    def __post_init__(self):
        self._name = E.Bank('SCOTIA BANK','2 Skywalket Avenue', 'Oacis', 'Marsian City', 'Mars','184 3DE').bankName
        self._endpoint = db.connect(host='10.0.0.55', user='dera', passwd='', port=3306, database='scotiadb')
